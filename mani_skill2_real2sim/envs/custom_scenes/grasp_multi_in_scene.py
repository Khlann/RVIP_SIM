...
class GraspMultipleInSceneEnv(CustomSceneEnv):
    ...
    def reset(self, seed=None, options=None):
        ...
        # pose_temp= Pose(np.array([0.39, 0.04, 0.07]), np.array([0, 0, 0, 1]))
        # self.agent.robot.pose = pose_temp
        ...
        info.update(
            {
                ...
                "obj_init_poses_wrt_robot_base": [
                    ...
                    # pose_temp.inv() * obj.pose for obj in self.objects
                ],
            }
        )
        return obs, info
...
class GraspMultipleCustomOrientationInSceneEnv(GraspMultipleCustomInSceneEnv):
    ...
    def reset(self, seed=None, options=None):
        ...
        # objj={'init_rot_quat_0': np.array([0.7071067811865476, 0.0 ,  0.0 , 0.7071067811865475]), 'init_rot_quat_1': np.array([0.7071067811865476,0.,0.7071067811865475,0.]),
        #  'init_rot_quat_2': np.array([0.7071067811865476,0.,  0.,  0.7071067811865475]), 'init_rot_quat_3': np.array([0.7071067811865476,0.7071067811865475,0.,  0.])}
